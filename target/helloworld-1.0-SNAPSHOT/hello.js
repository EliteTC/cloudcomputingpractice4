...
function enableButtons () {
	...
	btn = document.getElementById("input_get_time");
	btn.onclick=function(){getTime();};
	btn.value="Click me to print current date";
...
function getTime(){
	var request = gapi.client.helloworldendpoints.getTime();
	request.execute(sayHelloCallback);
